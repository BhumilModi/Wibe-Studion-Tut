    ...
    return (
        <Section ref={ref}>
            ...
            <Right ref={horizontalRef}>
                ...
                <Product image={img2} title="hi" />
                <Product image={img3} title="hi" />
                <Product image={img4} title="hi" />
                <Product image={img5} title="hi" />
                <Product image={img6} title="hi" />
                <Product image={img7} title="hi" />
                <Product image={img8} title="hi" />
                <Product image={img9} title="hi" />
                <Product image={img10} title="hi" />
            </Right>
        </Section>
    )
}
